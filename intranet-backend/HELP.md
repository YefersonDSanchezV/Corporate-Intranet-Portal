...
* The original package name 'co.com.icvc.intranet-backend' is invalid and this project uses 'co.com.icvc.intranet_backend' instead.
...
* [Spring Data LDAP](https://docs.spring.io/spring-boot/3.5.16/reference/data/nosql.html#data.nosql.ldap)
